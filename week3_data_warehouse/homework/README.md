...
You can load the data however you would like, but keep the files in .GZ Format. You can use the CSV option for the GZ files when creating an External Table.
