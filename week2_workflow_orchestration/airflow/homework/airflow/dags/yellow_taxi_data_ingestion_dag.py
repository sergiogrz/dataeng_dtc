...
csv_file_template = "yellow_taxi_{{ execution_date.strftime('%Y-%m') }}.csv.gz"
parquet_file_template = csv_file_template.replace(".csv.gz", ".parquet")
gcs_path_template = f"raw/yellow_taxi_data/{parquet_file_template}"
...
gcs = DAG(
    dag_id="yellow_taxi_data_ingestion_gcs",
